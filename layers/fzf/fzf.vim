...
function! layers#fzf#fzf#Session()
  call fzf#run({
...
" Oldfiles
" ------------------------------------------------------------------
function! layers#fzf#fzf#Oldfiles()
  redir => out
  silent oldfiles
  redir END
...
" FZF commands
" ------------------------------------------------------------------
function! layers#fzf#fzf#FZFCmd()
  redir => cout
  silent command
  redir END
  let list = split(cout, "\n")
...
" FZF find file
" ------------------------------------------------------------------
function! layers#fzf#fzf#FindFileInProject()
...
function! layers#fzf#fzf#AgInProject(query)
...
function! layers#fzf#fzf#SearchCword()
  call s:ag(expand('<cword>'))
endfunction

" Search visually selected
function! layers#fzf#fzf#Vsearch()
  call s:ag(spacevim#util#VisualSelection())
endfunction

function! layers#fzf#fzf#Rg(query, bang)
  if !executable('rg')
...
function! layers#fzf#fzf#SearchBcword()
